...
<body>
    ...
    <div class="container-fluid p-0">
        ...
        <div class="col-md-2 mt-5">
                <ul class="navbar-nav bg-secondary text-center">
                    ...
                    <?php 
                        ...
                        $user_img="select * from `user_table` where user_name='$user_name'";
                        $result_img=mysqli_query($con,$user_img);

                        while ($row = mysqli_fetch_array($result_img)) {
                            $image=$row["user_image"];
                            echo "
                            <li class='nav-item bg-white p-2'>
                                <img src='./user_images/$image' width='50%'>
                            </li>
                            ";
                        }
                    ?>
        ...
        <div class="col-md-10">
                <?php 
                    // Call a function named get_user_order_details that presumably gets the details of the user's orders from a database
                    get_user_order_details();

                    // Check if the GET parameter named edit_account is set
                    if(isset($_GET['edit_account'])){
                        include ('edit_account.php');
                    }

                    // Check if the GET parameter named my_orders is set
                    if(isset($_GET['my_orders'])){
                        include ('user_order.php');
                    }

                    // Check if the GET parameter named delete_account is set
