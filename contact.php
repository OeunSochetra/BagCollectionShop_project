...
<body>
    ...
    <div class="container-fluid p-0">
        ...
        <div class="row px-3 mt-5">
            <!-- product side -->
           <div class="col-md-4 text-center font-size"><a href=""><i class="fa-brands fa-square-facebook"></i></a></div>
           <div class="col-md-4 text-center font-size"><a href=""><i class="fa-brands fa-telegram"></i></a></div>
           <div class="col-md-4 text-center font-size"><a href=""><i class="fa-brands fa-square-instagram"></i></a></div>
